/**
 * bibha-video - bibha video is a Javascript tool to easily create beautiful, simple, mobile-friendly, vertical timelines.
 * @version v0.1.1
 * @link https://github.com/datanews/bibha-video
 * @license MIT
 */
/* global define:false */
...
(function(root, factory) {
  ...
  if (typeof module !== 'undefined' && module.exports && typeof require === 'function') {
    ...
    // Brower global
    root.bibhavideo = factory(root._, root.moment);
  }
})(typeof window !== 'undefined' ? window : this, function(_, moment) {
  // Check depdencies
  if (typeof _ === 'undefined') {
    throw new Error('Underscore is a necessary dependency of bibhavideo: http://underscorejs.org/');
  }

  if (typeof moment === 'undefined') {
    throw new Error('Moment is a necessary dependency of bibhavideo: http://momentjs.com/');
  }
  ...
  _.extend(bibhavideo.prototype, {
    ...
    build: function() {
      ...
      if (this.isBrowser) {
        ...
        this.id = this.el.id || this.uniqueId('bibha-video-timeline');
        this.el.id = this.id;
      }
    },
