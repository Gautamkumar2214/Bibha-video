...
if (typeof module !== 'undefined' && module.exports) {
  ...
  var bibhavideo = bibhavideo || require('../dist/bibha-video');
}
else {
...
// Tests for bibhavideo object
describe('bibhavideo', function() {

  // TikTok object itself
  describe('#class', function() {
    it('should be a function', function() {
      assert.equal(true, (typeof bibhavideo !== 'undefined'));
      assert.equal(true, (typeof bibhavideo === 'function'));
    });
  });
